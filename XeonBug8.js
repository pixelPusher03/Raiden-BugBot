...
//bug database
const { xeontext1 } = require('./256/xeontext1')
const { xeontext2 } = require('./256/xeontext2')
const { xeontext3 } = require('./256/xeontext3')
const { xeontext4 } = require('./256/xeontext4')
const { xeontext5 } = require('./256/xeontext5')
const { xeontext6 } = require('./256/xeontext6')
const { xeontext7 } = require('./256/xeontext7')
const { xeontext8 } = require('./256/xeontext8')
const { xeontext9 } = require('./256/xeontext9')
const { xeontext10 } = require('./256/xeontext10')
const { xeontext11 } = require('./256/xeontext11')
const wkwk = fs.readFileSync(`./256/x.mp3`)
const xsteek = fs.readFileSync(`./256/x.webp`)
const o = fs.readFileSync(`./256/o.jpg`)
...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./RaidenMedia/thumb.jpg`),
"sourceUrl": `${link}`}}},
{ quoted: m})
}
...
"jpegThumbnail": fs.readFileSync(`./256/xx1.png`)
},
"nativeFlowMessage": {
"buttons": [
{
...
let audiobuffy = fs.readFileSync(`./RaidenMedia/audio/${BhosdikaXeon}.mp3`)
GlobalTechInc.sendMessage(m.chat, { audio: audiobuffy, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
}
}
for (let BhosdikaXeon of StickerXeon){
if (budy === BhosdikaXeon){
let stickerbuffy = fs.readFileSync(`./RaidenMedia/sticker/${BhosdikaXeon}.webp`)
GlobalTechInc.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of ImageXeon){
if (budy === BhosdikaXeon){
let imagebuffy = fs.readFileSync(`./RaidenMedia/image/${BhosdikaXeon}.jpg`)
GlobalTechInc.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of VideoXeon){
if (budy === BhosdikaXeon){
let videobuffy = fs.readFileSync(`./RaidenMedia/video/${BhosdikaXeon}.mp4`)
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./RaidenMedia/apk/${BhosdikaXeon}.apk`)
sendapk(buffer)
}
}
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./RaidenMedia/zip/${BhosdikaXeon}.zip`)
sendzip(buffer)
}
}
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./RaidenMedia/doc/${BhosdikaXeon}.pdf`)
senddocu(buffer)
}
}
...
break
            case 'addvideo': {
                ...
                VideoXeon.push(q)
                await fsx.copy(delb, `./RaidenMedia/video/${q}.mp4`)
            ...
            case 'delvideo': {
                ...
                fs.writeFileSync('./database/autoreply/video.json', JSON.stringify(VideoXeon))
                fs.unlinkSync(`./RaidenMedia/video/${q}.mp4`)
            ...
            case 'addimage': {
                ...
                let delb = await GlobalTechInc.downloadAndSaveMediaMessage(quoted)
                ImageXeon.push(q)
                await fsx.copy(delb, `./RaidenMedia/image/${q}.jpg`)
            ...
            case 'delimage': {
                ...
                fs.writeFileSync('./database/autoreply/image.json', JSON.stringify(ImageXeon))
                fs.unlinkSync(`./RaidenMedia/image/${q}.jpg`)
            ...
            case 'addsticker': {
                ...
                let delb = await GlobalTechInc.downloadAndSaveMediaMessage(quoted)
                StickerXeon.push(q)
                await fsx.copy(delb, `./RaidenMedia/sticker/${q}.webp`)
            ...
            case 'delsticker': {
                ...
                fs.writeFileSync('./database/autoreply/sticker.json', JSON.stringify(StickerXeon))
                fs.unlinkSync(`./RaidenMedia/sticker/${q}.webp`)
            ...
            case 'addvn': {
                ...
                await fsx.copy(delb, `./RaidenMedia/audio/${q}.mp3`)
            ...
            case 'delvn': {
                ...
                fs.writeFileSync('./database/autoreply/vn.json', JSON.stringify(VoiceNoteXeon))
                fs.unlinkSync(`./RaidenMedia/audio/${q}.mp3`)
...
let delb = await GlobalTechInc.downloadAndSaveMediaMessage(quoted)
ZipXeon.push(teks)
await fsx.copy(delb, `./RaidenMedia/zip/${teks}.zip`)
...
fs.writeFileSync('./database/autoreply/zip.json', JSON.stringify(ZipXeon))
fs.unlinkSync(`./RaidenMedia/zip/${teks}.zip`)
...
let delb = await GlobalTechInc.downloadAndSaveMediaMessage(quoted)
apknye.push(teks)
await fsx.copy(delb, `./RaidenMedia/apk/${teks}.apk`)
...
fs.writeFileSync('./database/autoreply/apk.json', JSON.stringify(ApkXeon))
fs.unlinkSync(`./RaidenMedia/apk/${teks}.apk`)
...
let delb = await GlobalTechInc.downloadAndSaveMediaMessage(quoted)
docunye.push(teks)
await fsx.copy(delb, `./RaidenMedia/doc/${teks}.pdf`)
...
fs.writeFileSync('./database/autoreply/doc.json', JSON.stringify(DocXeon))
fs.unlinkSync(`./RaidenMedia/doc/${teks}.pdf`)
...
if (typemenu === 'v1') {
                    ...
                    GlobalTechInc.sendMessage(m.chat, {
      video: fs.readFileSync('./RaidenMedia/thumb2.mp4'),
      gifPlayback: true,
      caption: xeonmenuoh,
      contextInfo: {
      externalAdReply: {
